...
<template>
  <aside
    class="hidden xl:order-first xl:flex xl:flex-col flex-shrink-0 w-96 border-r border-gray-700"
  >
      ...
      >
        ...
        <ul role="list" class="relative z-0 divide-y divide-gray-700">
          <li v-for="person in directory[letter]" :key="person.id">
            <div
              class="relative px-6 py-5 flex items-center space-x-3 hover:bg-gray-700 focus-within:ring-2 focus-within:ring-inset focus-within:ring-pink-500"
            >
